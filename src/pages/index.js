      ...
      <main className="">
        <div className="row align-items-center">
                ...
                <div className="d-flex align-items-center gap-3 mb-5">
                  <div className="d-flex">
                    ...
                    <img
                      ...
                      alt=""
                      className="ratio-11 w-48 h-48 rounded-5 ms-n-8 border-custom"
                    />
                    <img
                    ...
                    />
                    <img
                      src="assets/images/demo/4.jpg"
                      alt=""
                      className="ratio-11 w-48 h-48 rounded-5 ms-n-8 border-custom"
                    />
                    <img
                      src="assets/images/demo/5.jpg"
                      alt=""
                      className="ratio-11 w-48 h-48 rounded-5 ms-n-8 border-custom"
                    />
                  </div>
                ...
                <div className="d-flex align-items-center gap-3 mb-5">
                  <div className="d-flex">
                    ...
                    <img
                      src="assets/images/demo/2.jpg"
                      alt=""
                      className="ratio-11 w-48 h-48 rounded-2 ms-n-8 border-custom"
                    />
                    <img
                      src="assets/images/demo/3.jpg"
                      alt=""
            ...
            <div className="d-flex flex-column animate__animated animate__fadeInUp animate__delay-2s">
              ...
              <div className="d-flex flex-wrap justify-content-lg-start justify-content-center gap-2 mb-5">
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://play.google.com/store/apps/details?id=com.foyou.app"
                  className="d-block"
                >
          ...
          <div className="offset-xl-1 col-xl-5 col-lg-6 position-relative">
            <img
              src="assets/images/phoneBG.svg"
              alt=""
              className="img-fluid position-absolute bottom-0 start-0 zindex-0 animate__animated animate__fadeInLeft animate__delay-1s"
            />
                          ...
                          <div class="swiper-slide">
                            <div className="d-flex gap-2 p-2 w-100">
                              ...
                              <div className="d-flex flex-column w-100">
                                ...
                                <span className="fs-12 d-block me-1">
                                  <div
                                    dangerouslySetInnerHTML={{ __html: num.content }}
                                    className="fs-12 d-block me-1"
                                  ></div>
                                </span>
                              </div>
                            </div>
